    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group has-feedback {{ $errors->has('title') ? 'has-error' : '' }}">
          ...
          {{ Form::textarea('title', $news->title, ['class' => 'form-control', 'required', 'autocomplete' => 'off', 'rows' => 3]) }}
          @if ($errors->has('title'))
        ...
        <div class="form-group has-feedback {{ $errors->has('image') ? 'has-error' : '' }}">
          ...
          <img id="previewImg" src={{ $news->image }}/>
          @if ($errors->has('image'))
          <span class="help-block">
        ...
        <div class="form-group has-feedback {{ $errors->has('link') ? 'has-error' : '' }}">
          ...
          {{ Form::text('link', $news->link, ['class' => 'form-control', 'required', 'autocomplete' => 'off']) }}
          @if ($errors->has('link'))
          <span class="help-block">
        ...
        <div class="form-group has-feedback {{ $errors->has('publish') ? 'has-error' : '' }}">
          ...
          {{ Form::select('publish', ['1' => 'Có','0' => 'Không'], $news->publish, ['class' => 'form-control', 'required', 'placeholder' => 'Chọn 1 trong số những lựa chọn sau']) }}
